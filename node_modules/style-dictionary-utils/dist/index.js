...
const typescript_esm_declarations_1 = require("./format/typescript-esm-declarations");
...
const name_path_to_camel_case_1 = require("./transformer/name-path-to-camel-case");
...
OrigialStyleDictionary.registerFormat({
    ...
    formatter: typescript_esm_declarations_1.typescriptEsmDeclarations
});
OrigialStyleDictionary.registerFormat({
    name: 'css/advanced',
...
OrigialStyleDictionary.registerTransform(Object.assign({ name: 'name/pathToCamelCase' }, name_path_to_camel_case_1.namePathToCamelCase));
